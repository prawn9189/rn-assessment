import { Check } from "@/scripts/icons/Check";
import { ChevronDown } from "@/scripts/icons/ChevronDown";
import { ChevronUp } from "@/scripts/icons/ChevronUp";
import { cn } from "@/scripts/util";
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    ...
    <SelectPrimitive.ItemText className="text-sm native:text-lg text-slate-900 text-popover-foreground native:text-base web:group-focus:text-accent-foreground" />
  </SelectPrimitive.Item>
));
